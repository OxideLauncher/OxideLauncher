...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading Oxide Launcher!");
            ...
            #[cfg(target_os = "windows")]
            {
                ...
                if format!("{e:?}").contains(
                    ...
                    DialogBuilder::message()
                        .set_level(MessageLevel::Error)
                        .set_title("Initialization error")
                        .set_text("Your Microsoft Edge WebView2 installation is corrupt.\n\nMicrosoft Edge WebView2 is required to run Oxide Launcher.\n\nLearn how to repair it at https://oxidelauncher.org/support/webview2")
                        .alert()
                        .show()
                        .unwrap();

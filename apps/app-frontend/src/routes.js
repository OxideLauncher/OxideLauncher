...
export default new createRouter({
	...
	routes: [
		...
		},
		{
			path: '/cf-project/:id',
			name: 'CfProject',
			component: () => import('@/pages/cf-project/Index.vue'),
			props: true,
			children: [
				{
					path: '',
					name: 'CfDescription',
					component: () => import('@/pages/cf-project/Description.vue'),
					meta: {
						useContext: true,
						breadcrumb: [{ name: '?CfProject' }],
					},
				},
				{
					path: 'versions',
					name: 'CfVersions',
					component: () => import('@/pages/cf-project/Versions.vue'),
					meta: {
						useContext: true,
				...
				},
				{
					path: 'gallery',
					name: 'CfGallery',
					component: () => import('@/pages/cf-project/Gallery.vue'),
					meta: {
						useContext: true,
						breadcrumb: [{ name: '?CfProject', link: '/cf-project/{id}/' }, { name: 'Gallery' }],
					},
				},
			],
		},

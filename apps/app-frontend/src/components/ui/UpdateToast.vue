...
import { DownloadIcon, ExternalIcon, RefreshCwIcon, SpinnerIcon, XIcon } from '@oxide/assets'
import { ButtonStyled, commonMessages, defineMessages, ProgressBar, useVIntl } from '@oxide/ui'
...
const messages = defineMessages({
	...
	body: {
		...
		defaultMessage:
			'Oxide Launcher v{version} is ready to install! Reload to update now, or automatically when you close Oxide Launcher.',
	},
	reload: {
	...
	meteredBody: {
		...
		defaultMessage: `Oxide Launcher v{version} is available now! Since you're on a metered network, we didn't automatically download it.`,
	},
	...
	downloadedBody: {
		...
		defaultMessage: `Oxide Launcher v{version} has finished downloading. Reload to update now, or automatically when you close Oxide Launcher.`,
	},
})
</script>
<template>

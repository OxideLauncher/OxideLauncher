<script setup>
import { BoxIcon, FolderSearchIcon, TrashIcon } from '@oxide/assets'
import { Button, injectNotificationManager, Slider } from '@oxide/ui'
...
<template>
	...
	<div>
		...
		<p class="m-0 mt-1 mb-2 leading-tight text-secondary">
			The Oxide Launcher stores a cache of data to speed up loading. This can be purged to force the

...
<script setup>
import { CheckIcon, DownloadIcon, ExternalIcon, FileIcon, ReportIcon } from '@oxide/assets'
import { Avatar, Badge, Breadcrumbs, Button, Card, CopyCode } from '@oxide/ui'
import { formatBytes, renderString } from '@oxide/utils'

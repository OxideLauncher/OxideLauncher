...
import { arrayBufferToBase64 } from '@oxide/utils'
...
<template>
	...
	<div v-else class="flex items-center justify-center min-h-[50vh] pt-[15%]">
		<div
			class="bg-bg-raised rounded-xl p-8 flex flex-col items-center gap-6 shadow-lg max-w-md w-full mx-auto text-center"
		>
			<div class="bg-brand/10 rounded-full p-4">
				<UserIcon class="size-12 text-brand" aria-hidden="true" />
			</div>
			<div class="flex flex-col gap-3">
				<h1 class="text-2xl font-bold m-0">Sign in required</h1>
				<p class="text-secondary m-0">
					Sign into your Minecraft account to manage your skins.
				</p>
			</div>

<template>
	<Card class="log-card">
		...
		<ShareModalWrapper
			...
			share-text="Check out this log from an instance on the Oxide Launcher"
...
import { CheckIcon, ClipboardCopyIcon, ShareIcon, TrashIcon } from '@oxide/assets'
import { Button, Card, Checkbox, DropdownSelect, injectNotificationManager } from '@oxide/ui'

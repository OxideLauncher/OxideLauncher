<script setup>
import { AuthFeature, PanelVersionFeature, TauriModrinthClient } from '@oxide/api-client'
import {
    ChangeSkinIcon,
    CompassIcon,
    DownloadIcon,
...
import OxideLauncherLogo from '@/assets/oxide_launcher.svg?component'
...
<template>
	...
	>
		...
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			<div data-tauri-drag-region class="flex p-3">
				<OxideLauncherLogo class="h-full w-auto text-contrast pointer-events-none" />
	...
	>
			...
			<transition name="popup-survey">
				...
				>
					...
					<p class="m-0 leading-tight">
						Would you mind answering a few questions about your experience with Oxide Launcher?
					</p>
					<p class="mt-3 mb-4 leading-tight">
						This feedback will go directly to the Oxide team and help guide future updates!
					</p>
		...
		>
			<div
				class="app-sidebar-scrollable flex-grow shrink overflow-y-auto relative pb-12"
			>

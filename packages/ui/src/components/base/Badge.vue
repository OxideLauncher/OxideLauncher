<template>
	<span :class="'version-badge ' + color + ' type--' + type">
		...
		<template v-else-if="type === 'admin'">
			<OxideIcon aria-hidden="true" /> {{ formatMessage(messages.oxideTeamLabel) }}
		</template>
...
import { capitalizeString } from '@oxide/utils'
...
const messages = defineMessages({
	...
	oxideTeamLabel: {
		id: 'omorphia.component.badge.label.oxide-team',
		defaultMessage: 'Oxide Team',
	},
	pendingLabel: {

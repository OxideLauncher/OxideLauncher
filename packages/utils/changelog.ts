...
- Added limits for creating content on Modrinth
	...
	},
	{
		...
		version: '0.10.8',
		body: `### Improvements
- Overhauled Oxide Launcher updater to make it easier to stay up-to-date.
...
- Fixed world seed being rounded in options.`,
	},
	{
		...
		product: 'web',
		body: `### Improvements
- Fixed Oxide Launcher sign in redirect when using SSO.`,
	},
	{
		date: `2025-09-03T15:40:00-07:00`,
		product: 'web',
		body: `### Improvements
- Fixed a number of bugs with the Oxide Launcher marketing page
- Added clearer notices about Oxide Launcher's beta status on marketing page.
- Added disclaimer about Oxide Launcher's issues on Linux to marketing page.
...
- On Windows, the app will now install per-user rather than system-wide.
	- This allows future versions of Oxide Launcher to update seamlessly if the user is not an administrator.
...
- Added system for showing users surveys to provide feedback on their experience with Oxide Launcher.
...
- Fixed news section rendering incorrectly in light mode on landing page and Oxide Launcher page.`,
	},
	{
...
- Updated Oxide Launcher marketing page screenshots.`,
	},
	{
...
- Improved wording of unprovisioned servers, to inform people that newly purchased servers may be unprovisioned for a small amount of time.`,
	},
	{
		...
		product: 'web',
		body: `### Improvements
- Combined Apple Silicon and Intel download links for Oxide Launcher into one link.
...
- Improved ability for package managers to update Oxide Launcher by skipping the updater at runtime with an environment variable.`,
	},
	{
